...
class MockProjectService implements ProjectService {
  ...
  @override
  ValueListenable<List<GcpProject>> get starredProjects => ValueNotifier([]);
  @override
  ...
  @override
  bool isStarred(String projectId) => false;
  @override
...
class MockExplorerQueryService implements ExplorerQueryService {
  ...
  @override
  Future<void> queryLogs({required String filter, String? projectId, String? pageToken, int? limit}) async {}
  @override
...
class MockSessionService implements SessionService {
  @override
  ValueListenable<List<SessionSummary>> get sessions => ValueNotifier([]);
  @override
  ValueListenable<String?> get currentSessionId => ValueNotifier(null);
  @override
  ValueListenable<bool> get isLoading => ValueNotifier(false);
  @override
  ValueListenable<String?> get error => ValueNotifier(null);
  ...
  @override
  Future<Session?> getSession(String sessionId) async => null;
  @override
  Future<bool> deleteSession(String sessionId) async => true;
  @override
  Future<bool> renameSession(String sessionId, String newTitle) async => true;
  @override
...
class MockConnectivityService extends ChangeNotifier
  ...
  ValueListenable<ConnectivityStatus> get status =>
      ValueNotifier(ConnectivityStatus.connected);
  @override
...
class MockToolConfigService implements ToolConfigService {
  ...
  ValueListenable<String?> get error => ValueNotifier(null);
  @override
  ValueListenable<ToolConfigSummary?> get summary => ValueNotifier(null);
  @override
  ValueListenable<Set<String>> get testingTools => ValueNotifier({});
  @override
  ...
  @override
  Future<ToolTestResult?> testTool(String toolName) async => null;
  @override
  Future<Map<String, ToolTestResult>> testAllTools({
    ToolCategory? category,
  }) async => {};
  @override
  Future<bool> setToolEnabled(String toolName, bool enabled) async => true;
  @override
  Future<bool> bulkUpdateTools(Map<String, bool> updates) async => true;
  @override
  Future<bool> enableCategory(ToolCategory category) async => true;
  @override
  Future<bool> disableCategory(ToolCategory category) async => true;
  @override
  void dispose() {}
}
...
class MockADKContentGenerator implements ADKContentGenerator {
  ...
  void emitToolCall(Map<String, dynamic> event) =>
...
void setupMockSingletons({
  ...
  PromptHistoryService.mockInstance =
      promptHistory ?? MockPromptHistoryService();
