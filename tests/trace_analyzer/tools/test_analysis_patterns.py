...
def test_compare_span_timings_n_plus_one_detection():
    ...
    baseline = {
        "trace_id": "base",
        "spans": [{"span_id": "r", "name": "root", "start_time": "2023-01-01T00:00:00Z", "end_time": "2023-01-01T00:00:01Z"}]
    }
    
    # Construct a trace with N+1 pattern: 5 sequential calls to "db_query"
    spans = [{"span_id": "root", "name": "root", "start_time": "2023-01-01T00:00:00Z", "end_time": "2023-01-01T00:00:05Z"}]
