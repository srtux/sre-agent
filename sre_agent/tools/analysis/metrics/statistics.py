...
def calculate_series_stats(
    ...
    stats = {
        ...
        "min": points_sorted[0],
        "max": points_sorted[-1],
        # Performance optimization: native math (sum, /) is ~20-80x faster than statistics.mean
    ...
    if count > 1:
        # Performance optimization: native variance and stdev computation is significantly faster than statistics module
        mean_val = stats["mean"]
